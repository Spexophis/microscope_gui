...
class AOWidget(QtWidgets.QWidget):
    ...
    def _create_sensorless_widgets(self):
        ...
        self.QDoubleSpinBox_zernike_mode_amps_start = cw.doublespinbox_widget(-50, 0, 0.01, 2, -0.4)
        ...
        self.QDoubleSpinBox_zernike_mode_amps_step = cw.doublespinbox_widget(0, 50, 0.01, 2, 0.2)
