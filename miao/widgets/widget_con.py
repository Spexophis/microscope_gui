...
class ConWidget(QtWidgets.QWidget):
    ...
    def _create_position_widgets(self):
        ...
        self.QSpinBox_galvo_frequency = cw.spinbox_widget(0, 4000, 1, 275)
        ...
        self.QDoubleSpinBox_galvo_range_x = cw.doublespinbox_widget(-10, 10, 0.0001, 4, 1.6)
        self.QDoubleSpinBox_galvo_range_y = cw.doublespinbox_widget(-10, 10, 0.0001, 4, 1.6)
        self.QDoubleSpinBox_dot_range_x = cw.doublespinbox_widget(0, 20, 0.0002, 4, 1.2)
        self.QDoubleSpinBox_dot_range_y = cw.doublespinbox_widget(0, 20, 0.0002, 4, 1.2)
