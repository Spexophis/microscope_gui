...
class ConWidget(QtWidgets.QWidget):
    ...
    def _create_position_widgets(self):
        ...
        mcl_piezo_scroll_layout.addRow(cw.label_widget(str('PID - kP')), self.QDoubleSpinBox_pid_kp)
        mcl_piezo_scroll_layout.addRow(cw.label_widget(str('PID - kI')), self.QDoubleSpinBox_pid_ki)
        mcl_piezo_scroll_layout.addRow(cw.label_widget(str('PID - kD')), self.QDoubleSpinBox_pid_kd)
        ...
        galvo_scroll_layout.addRow(cw.label_widget(str('Frequency / Hz')), self.QLCDNumber_galvo_frequency)
        galvo_scroll_layout.addRow(cw.frame_widget())
    ...
    def _create_daq_widgets(self):
        ...
        self.daq_scroll_area, daq_scroll_layout = cw.create_scroll_area()
        self.do_0_scroll_area, do_0_scroll_layout = cw.create_scroll_area()
        self.do_1_scroll_area, do_1_scroll_layout = cw.create_scroll_area()
        self.do_2_scroll_area, do_2_scroll_layout = cw.create_scroll_area()
        self.do_3_scroll_area, do_3_scroll_layout = cw.create_scroll_area()
        self.do_4_scroll_area, do_4_scroll_layout = cw.create_scroll_area()
        self.do_5_scroll_area, do_5_scroll_layout = cw.create_scroll_area()
        self.do_6_scroll_area, do_6_scroll_layout = cw.create_scroll_area()
        self.do_7_scroll_area, do_7_scroll_layout = cw.create_scroll_area()
        daq_scroll_layout.addRow(cw.label_widget(str('Parameter')))
        daq_scroll_layout.addRow(cw.frame_widget())
        daq_scroll_layout.addRow(cw.label_widget(str('Sample Rate / KS/s')), self.QSpinBox_daq_sample_rate)
        daq_scroll_layout.addRow(self.QPushButton_plot_trigger)
        do_0_scroll_layout.addRow(cw.label_widget(str('DO#0 - L405')))
        do_0_scroll_layout.addRow(cw.frame_widget())
        do_0_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_0_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_on_405, self.QDoubleSpinBox_ttl_stop_on_405)
        do_1_scroll_layout.addRow(cw.label_widget(str('DO#1 - L488')))
        do_1_scroll_layout.addRow(cw.frame_widget())
        do_1_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_1_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_off_488_0, self.QDoubleSpinBox_ttl_stop_off_488_0)
        do_2_scroll_layout.addRow(cw.label_widget(str('DO#2 - L488')))
        do_2_scroll_layout.addRow(cw.frame_widget())
        do_2_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_2_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_off_488_1, self.QDoubleSpinBox_ttl_stop_off_488_1)
        do_3_scroll_layout.addRow(cw.label_widget(str('DO#3 - L488')))
        do_3_scroll_layout.addRow(cw.frame_widget())
        do_3_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_3_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_read_488_2, self.QDoubleSpinBox_ttl_stop_read_488_2)
        do_4_scroll_layout.addRow(cw.label_widget(str('DO#4 - iXon')))
        do_4_scroll_layout.addRow(cw.frame_widget())
        do_4_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_4_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_emccd, self.QDoubleSpinBox_ttl_stop_emccd)
        do_5_scroll_layout.addRow(cw.label_widget(str('DO#5 - ORCA')))
        do_5_scroll_layout.addRow(cw.frame_widget())
        do_5_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_5_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_scmos, self.QDoubleSpinBox_ttl_stop_scmos)
        do_6_scroll_layout.addRow(cw.label_widget(str('DO#6 - Kira')))
        do_6_scroll_layout.addRow(cw.frame_widget())
        do_6_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_6_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_thorcam, self.QDoubleSpinBox_ttl_stop_thorcam)
        do_7_scroll_layout.addRow(cw.label_widget(str('DO#7 - DMK')))
        do_7_scroll_layout.addRow(cw.frame_widget())
        do_7_scroll_layout.addRow(cw.label_widget(str('From / s')), cw.label_widget(str('To / s')))
        do_7_scroll_layout.addRow(self.QDoubleSpinBox_ttl_start_tis, self.QDoubleSpinBox_ttl_stop_tis)
        
        layout_daq.addWidget(self.daq_scroll_area)
        layout_daq.addWidget(self.do_0_scroll_area)
        layout_daq.addWidget(self.do_1_scroll_area)
        layout_daq.addWidget(self.do_2_scroll_area)
        layout_daq.addWidget(self.do_3_scroll_area)
        layout_daq.addWidget(self.do_4_scroll_area)
        layout_daq.addWidget(self.do_5_scroll_area)
        layout_daq.addWidget(self.do_6_scroll_area)
        layout_daq.addWidget(self.do_7_scroll_area)
        return layout_daq
