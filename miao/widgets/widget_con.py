...
class ConWidget(QtWidgets.QWidget):
    ...
    def _create_camera_widgets(self):
        ...
        self.QDoubleSpinBox_ttl_start_emccd = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_emccd = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
        ...
        self.QDoubleSpinBox_ttl_start_scmos = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_scmos = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
        ...
        self.QDoubleSpinBox_ttl_start_tis = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_tis = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
    ...
    def _create_position_widgets(self):
        ...
        self.QDoubleSpinBox_step_x = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.032)
        self.QDoubleSpinBox_range_x = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.640)
        ...
        self.QDoubleSpinBox_step_y = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.032)
        self.QDoubleSpinBox_range_y = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.640)
        ...
        self.QDoubleSpinBox_step_z = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.128)
        self.QDoubleSpinBox_range_z = cw.doublespinbox_widget(0, 50, 0.001, 3, 2.56)
        ...
        self.QSpinBox_galvo_frequency = cw.spinbox_widget(0, 4000, 1, 160)
        ...
        self.QDoubleSpinBox_galvo_range_x = cw.doublespinbox_widget(-10, 10, 0.0001, 4, 1.2)
        self.QDoubleSpinBox_galvo_range_y = cw.doublespinbox_widget(-10, 10, 0.0001, 4, 1.2)
        self.QDoubleSpinBox_dot_range_x = cw.doublespinbox_widget(0, 20, 0.0002, 4, 1.0)
        self.QDoubleSpinBox_dot_range_y = cw.doublespinbox_widget(0, 20, 0.0002, 4, 1.0)
        self.QSpinBox_dot_step = cw.spinbox_widget(0, 4000, 1, 11)
        self.QDoubleSpinBox_dot_step = cw.doublespinbox_widget(0, 20, 0.0001, 4, 0.0)
    ...
    def _create_laser_widgets(self):
        ...
        self.QDoubleSpinBox_ttl_start_on_405 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.000)
        self.QDoubleSpinBox_ttl_stop_on_405 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.005)
        self.QLabel_laser_488_0_starts = cw.label_widget(str('From / s'))
        self.QLabel_laser_488_0_stops = cw.label_widget(str('To / s'))
        self.QDoubleSpinBox_ttl_start_off_488_0 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_off_488_0 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
        self.QLabel_laser_488_1_starts = cw.label_widget(str('From / s'))
        self.QLabel_laser_488_1_stops = cw.label_widget(str('To / s'))
        self.QDoubleSpinBox_ttl_start_off_488_1 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_off_488_1 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
        self.QLabel_laser_488_2_starts = cw.label_widget(str('From / s'))
        self.QLabel_laser_488_2_stops = cw.label_widget(str('To / s'))
        self.QDoubleSpinBox_ttl_start_read_488_2 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.010)
        self.QDoubleSpinBox_ttl_stop_read_488_2 = cw.doublespinbox_widget(0, 50, 0.001, 3, 0.065)
    ...
    def update_acquisition_parameter_sets(self, text: str):
        ...
        if text == "Dot Scan 3D":
            ...
            self.QDoubleSpinBox_step_y.setValue(0.032)
            self.QDoubleSpinBox_step_z.setValue(0.128)
            self.QDoubleSpinBox_range_x.setValue(0.864)
            self.QDoubleSpinBox_range_y.setValue(0.864)
            self.QDoubleSpinBox_range_z.setValue(3.200)
            self.QDoubleSpinBox_ttl_start_on_405.setValue(0.000)
            self.QDoubleSpinBox_ttl_stop_on_405.setValue(0.005)
            self.QDoubleSpinBox_ttl_start_off_488_0.setValue(0.010)
        ...
        if text == "Monalisa Scan 2D":
            ...
            self.QDoubleSpinBox_range_x.setValue(0.880)
            self.QDoubleSpinBox_range_y.setValue(0.880)
            self.QDoubleSpinBox_range_z.setValue(0.000)
