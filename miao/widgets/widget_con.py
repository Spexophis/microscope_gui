...
class ConWidget(QtWidgets.QWidget):
    ...
    def _create_position_widgets(self):
        ...
        self.QDoubleSpinBox_galvo_start_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, -0.9)
        self.QDoubleSpinBox_galvo_stop_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, 0.9)
        self.QDoubleSpinBox_galvo_start_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, -0.9)
        self.QDoubleSpinBox_galvo_stop_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, 0.9)
    ...
    def update_trigger_parameter_sets(self, text: str):
        ...
        if text == "Confocal 3D":
            ...
            self.QDoubleSpinBox_step_y.setValue(0.032)
            self.QDoubleSpinBox_step_z.setValue(0.128)
            self.QDoubleSpinBox_range_x.setValue(0.096)
            self.QDoubleSpinBox_range_y.setValue(0.096)
            self.QDoubleSpinBox_range_z.setValue(3.200)
            self.QDoubleSpinBox_ttl_start_on_405.setValue(0.000)
            self.QDoubleSpinBox_ttl_stop_on_405.setValue(0.005)
            self.QDoubleSpinBox_ttl_start_off_488_0.setValue(0.010)
