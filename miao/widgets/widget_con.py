...
class ConWidget(QtWidgets.QWidget):
    ...
    def _create_position_widgets(self):
        ...
        self.QDoubleSpinBox_galvo_start_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, -0.8)
        self.QDoubleSpinBox_galvo_stop_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, 0.8)
        self.QDoubleSpinBox_galvo_start_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, -0.8)
        self.QDoubleSpinBox_galvo_stop_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, 0.8)
