...
class ConWidget(QtWidgets.QWidget):
    ...
    def update_trigger_parameter_sets(self):
        ...
        if presets == "Live":
            ...
            self.QDoubleSpinBox_ttl_stop_off_488_0.setValue(0.025)
            self.QDoubleSpinBox_ttl_start_off_488_1.setValue(0.010)
            self.QDoubleSpinBox_ttl_stop_off_488_1.setValue(0.025)
            self.QDoubleSpinBox_ttl_start_read_488_2.setValue(0.030)
            self.QDoubleSpinBox_ttl_stop_read_488_2.setValue(0.050)
            self.QDoubleSpinBox_ttl_start_camera_main.setValue(0.030)
            self.QDoubleSpinBox_ttl_stop_camera_main.setValue(0.050)
            self.QDoubleSpinBox_ttl_start_camera_wfs.setValue(0.030)
