...
class ConWidget(QtWidgets.QWidget):
    ...
    def __init__(self, config, logg, path, *args, **kwargs):
        ...
        self.QDoubleSpinBox_galvo_start_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, -1.6)
        self.QDoubleSpinBox_galvo_stop_x = cw.doublespinbox_widget(-10, 10, 0.001, 3, 1.6)
        self.QDoubleSpinBox_galvo_start_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, -1.6)
        self.QDoubleSpinBox_galvo_stop_y = cw.doublespinbox_widget(-10, 10, 0.001, 3, 1.6)
        ...
        self.QDoubleSpinBox_dot_start = cw.doublespinbox_widget(-10, 10, 0.02, 2, -1.0)
        self.QDoubleSpinBox_dot_range = cw.doublespinbox_widget(0, 20, 0.02, 2, 2.0)
        self.QDoubleSpinBox_dot_step = cw.doublespinbox_widget(0, 20, 0.01, 2, 0.05)
