...
class ConWidget(QtWidgets.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.QDoubleSpinBox_stage_x = cw.doublespinbox_widget(0, 100, 0.02, 2, 0.00)
        self.QLCDNumber_piezo_position_x = cw.lcdnumber_widget()
        self.QLabel_stage_y = cw.label_widget(str('Y (um)'))
        self.QDoubleSpinBox_stage_y = cw.doublespinbox_widget(0, 100, 0.02, 2, 0.00)
        ...
        Layout_Triggers.addWidget(self.QLabel_ttl_camera_tis, 9, 3, 1, 1)
        ...
        Layout_Triggers.addWidget(self.QDoubleSpinBox_ttl_start_camera_tis, 10, 3, 1, 1)
        Layout_Triggers.addWidget(self.QDoubleSpinBox_ttl_stop_camera_tis, 11, 3, 1, 1)
