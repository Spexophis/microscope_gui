...
class ConWidget(QtWidgets.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Layout_Illumination.addWidget(self.QRadioButton_laser_405, 0, 0, 1, 1)
        Layout_Illumination.addWidget(self.QDoubleSpinBox_laserpower_405, 0, 1, 1, 1)
        Layout_Illumination.addWidget(self.QPushButton_laser_405, 0, 2, 1, 1)
        Layout_Illumination.addWidget(self.QRadioButton_laser_488_0, 1, 0, 1, 1)
        Layout_Illumination.addWidget(self.QDoubleSpinBox_laserpower_488_0, 1, 1, 1, 1)
        Layout_Illumination.addWidget(self.QPushButton_laser_488_0, 1, 2, 1, 1)
        Layout_Illumination.addWidget(self.QRadioButton_laser_488_1, 2, 0, 1, 1)
        Layout_Illumination.addWidget(self.QDoubleSpinBox_laserpower_488_1, 2, 1, 1, 1)
        Layout_Illumination.addWidget(self.QPushButton_laser_488_1, 2, 2, 1, 1)
        Layout_Illumination.addWidget(self.QRadioButton_laser_488_2, 3, 0, 1, 1)
        Layout_Illumination.addWidget(self.QDoubleSpinBox_laserpower_488_2, 3, 1, 1, 1)
        Layout_Illumination.addWidget(self.QPushButton_laser_488_2, 3, 2, 1, 1)
        ...
        Layout_Triggers.addWidget(self.QPushButton_plot_trigger, 0, 7, 2, 2)
        ...
        Layout_Triggers.addWidget(self.QLabel_piezo_start, 0, 1, 1, 2)
        Layout_Triggers.addWidget(self.QDoubleSpinBox_piezo_start, 1, 1, 1, 2)
        Layout_Triggers.addWidget(self.QLabel_trigger_parameter, 0, 3, 1, 1)
        Layout_Triggers.addWidget(self.QComboBox_trigger_parameter, 0, 4, 1, 2)
        Layout_Triggers.addWidget(self.QLabel_camera_selection, 1, 3, 1, 1)
        ...
        Layout_Triggers.addWidget(self.QLabel_ttl_camera_dm, 6, 8, 1, 1)
        ...
        Layout_Triggers.addWidget(self.QDoubleSpinBox_ttl_start_camera_dm, 7, 8, 1, 1)
        ...
        Layout_Triggers.addWidget(self.QDoubleSpinBox_ttl_stop_camera_dm, 8, 8, 1, 1)
