...
class ConWidget(QtWidgets.QWidget):
    ...
    def __init__(self, config, logg, path, *args, **kwargs):
        ...
        # self.QSpinBox_tis_coordinate_x = cw.spinbox_widget(0, 2048, 1, 0)
        # self.QSpinBox_tis_coordinate_y = cw.spinbox_widget(0, 2048, 1, 0)
        # self.QSpinBox_tis_coordinate_n = cw.spinbox_widget(0, 2048, 1, 2048)
        # self.QSpinBox_tis_coordinate_bin = cw.spinbox_widget(0, 2048, 1, 1)
        ...
        # tis_scroll_layout.addRow(cw.label_widget(str('N')), self.QSpinBox_tis_coordinate_n)
        # tis_scroll_layout.addRow(cw.label_widget(str('Bin')), self.QSpinBox_tis_coordinate_bin)
