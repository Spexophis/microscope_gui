...
class AOWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        Group_parameters = cw.group_widget('SH Parameters')
        ...
        Layout_exposuretime.addWidget(self.Label_exposuretime, 0, 1, 1, 1)
        Layout_exposuretime.addWidget(self.QDoubleSpinBox_exposuretime, 0, 2, 1, 1)
        ...
        self.Label_base_xcenter = cw.label_widget(str('X_center (Base)'))
        self.QSpinBox_base_xcenter = cw.spinbox_widget(0, 2048, 1, 1024)
        self.Label_base_ycenter = cw.label_widget(str('Y_center (Base)'))
        self.QSpinBox_base_ycenter = cw.spinbox_widget(0, 2048, 1, 1024)
        self.Label_offset_xcenter = cw.label_widget(str('X_center (Offset)'))
        self.QSpinBox_offset_xcenter = cw.spinbox_widget(0, 2048, 1, 1024)
        self.Label_offset_ycenter = cw.label_widget(str('Y_center (Offset)'))
        ...
        self.Label_wfrmd = cw.label_widget(str('Method'))
        self.QComboBox_wfrmd = cw.combobox_widget(list_items=['correlation', 'centerofmass'])
        Layout_parameters.addWidget(self.Label_wfrmd, 0, 1, 1, 1)
        Layout_parameters.addWidget(self.QComboBox_wfrmd, 0, 2, 1, 2)
        ...
        self.Label_wfsmd = cw.label_widget(str('Method'))
        ...
        Layout_deformablemirror.addWidget(self.Label_wfsmd, 0, 1, 1, 1)
        Layout_deformablemirror.addWidget(self.QComboBox_wfsmd, 0, 2, 1, 2)
        Layout_deformablemirror.addWidget(self.Label_actuator, 1, 0, 1, 1)
        Layout_deformablemirror.addWidget(self.QSpinBox_actuator, 1, 1, 1, 1)
        Layout_deformablemirror.addWidget(self.Label_actuator_push, 2, 0, 1, 1)
        Layout_deformablemirror.addWidget(self.QDoubleSpinBox_actuator_push, 2, 1, 1, 1)
        Layout_deformablemirror.addWidget(self.button_push_actuator, 3, 0, 1, 2)
        Layout_deformablemirror.addWidget(self.button_influence_fuction_laser, 3, 1, 1, 1)
        Layout_deformablemirror.addWidget(self.Label_zernike_mode, 1, 2, 1, 1)
        Layout_deformablemirror.addWidget(self.QSpinBox_zernike_mode, 1, 3, 1, 1)
        Layout_deformablemirror.addWidget(self.Label_zernike_mode_amp, 2, 2, 1, 1)
        Layout_deformablemirror.addWidget(self.QDoubleSpinBox_zernike_mode_amp, 2, 3, 1, 1)
        Layout_deformablemirror.addWidget(self.button_set_zernike_mode, 3, 2, 1, 2)
        Layout_deformablemirror.addWidget(self.QComboBox_cmd, 4, 0, 1, 1)
        Layout_deformablemirror.addWidget(self.button_setDM, 4, 1, 1, 1)
        Layout_deformablemirror.addWidget(self.button_loadDM, 3, 3, 1, 1)
        Layout_deformablemirror.addWidget(self.button_update_cmd, 4, 2, 1, 1)
        Layout_deformablemirror.addWidget(self.button_save_dm, 4, 3, 1, 1)
