...
class AOWidget(QtWidgets.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.QLabel_exposuretime = cw.label_widget(str('Exposure time'))
        ...
        layout_exposuretime.addWidget(self.QLabel_exposuretime, 0, 0, 1, 1)
        layout_exposuretime.addWidget(self.QDoubleSpinBox_exposuretime, 0, 1, 1, 1)
        layout_exposuretime.addWidget(self.QLabel_wfmin, 1, 0, 1, 1)
        layout_exposuretime.addWidget(self.lcdNumber_wfmin, 2, 0, 1, 1)
        layout_exposuretime.addWidget(self.QLabel_wfmax, 1, 1, 1, 1)
        layout_exposuretime.addWidget(self.lcdNumber_wfmax, 2, 1, 1, 1)
        layout_exposuretime.addWidget(self.QLabel_wfrms, 1, 2, 1, 1)
        ...
        layout_shwfs.addWidget(self.button_shwfs_base, 0, 1, 1, 1)
        layout_shwfs.addWidget(self.button_run_wfs, 0, 0, 1, 1)
        ...
        layout_deformablemirror.addWidget(self.button_push_actuator, 3, 0, 1, 1)
        ...
        self.button_shwfs_base.clicked.connect(self.set_wfs_base)
