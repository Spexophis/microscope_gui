...
class AOWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addStretch()
        layout.addWidget(Dock_exposuretime)
        ...
        Layout_parameters.addWidget(self.Label_wfrmd, 0, 0, 1, 1)
        ...
        Layout_deformablemirror.addWidget(self.Label_wfsmd, 0, 0, 1, 1)
        Layout_deformablemirror.addWidget(self.QComboBox_wfsmd, 0, 1, 1, 2)
