...
class AOWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        Layout_exposuretime.addRow(self.Label_exposuretime, self.QDoubleSpinBox_exposuretime)
        Layout_exposuretime.addRow(self.Label_shimgmax, self.lcdNumber_shimgmax)
        Layout_exposuretime.addRow(self.Label_shimgmin, self.lcdNumber_shimgmin)
        Layout_exposuretime.addRow(self.Label_wfmax, self.lcdNumber_wfmax)
        ...
        self.Label_diamter = cw.label_widget(str('Diamter'))
        self.QSpinBox_diamter = cw.spinbox_widget(0, 64, 1, 14)
        ...
        self.QDoubleSpinBox_actuator_push = cw.doublespinbox_widget(-1, 1, 0.005, 3, 0.00)
        self.button_push_actuator = cw.pushbutton_widget('Push Actuator')
        ...
        self.QDoubleSpinBox_zernike_mode_amp = cw.doublespinbox_widget(-20, 20, 0.01, 2, 0.00)
        ...
        self.QDoubleSpinBox_zernike_mode_amps_start = cw.doublespinbox_widget(-50, 50, 0.01, 2, -1.6)
        ...
        self.QDoubleSpinBox_zernike_mode_amps_step = cw.doublespinbox_widget(0, 50, 0.01, 2, 0.8)
        ...
        self.Label_metric_function = cw.label_widget(str('Image Quality Metric'))
