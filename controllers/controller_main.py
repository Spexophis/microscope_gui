...
class MainController():
    ...
    def generate_digital_trigger(self, l):
        ...
        self.p.trigger.updata_parameters(sequence_time, sample_rate, axis_lengths, step_sizes, axis_start_pos, return_time, convFactors, analog_start, ttl_starts, ttl_ends)
