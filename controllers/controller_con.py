# -*- coding: utf-8 -*-
"""
Created on Wed Apr  6 14:07:10 2022
...
class ConController():
    ...
    def get_trigger_parameters(self):
        ...
        axis_lengths = [self.view.QDoubleSpinBox_range_x.value(), self.view.QDoubleSpinBox_range_y.value(), self.view.QDoubleSpinBox_range_z.value()]
        step_sizes = [self.view.QDoubleSpinBox_step_x.value(), self.view.QDoubleSpinBox_step_y.value(), self.view.QDoubleSpinBox_step_z.value()]
        axis_start_pos = [self.view.QDoubleSpinBox_start_x.value(), self.view.QDoubleSpinBox_start_y.value(), self.view.QDoubleSpinBox_start_z.value()]
        analog_start = self.view.QDoubleSpinBox_piezo_start.value()
        ttl_starts = [self.view.QDoubleSpinBox_ttl_start_on_405.value(), self.view.QDoubleSpinBox_ttl_start_off_488_0.value(), self.view.QDoubleSpinBox_ttl_start_off_488_1.value(), self.view.QDoubleSpinBox_ttl_start_read_488_2.value(), self.view.QDoubleSpinBox_ttl_start_camera.value()]
        ttl_ends = [self.view.QDoubleSpinBox_ttl_stop_on_405.value(), self.view.QDoubleSpinBox_ttl_stop_off_488_0.value(), self.view.QDoubleSpinBox_ttl_stop_off_488_1.value(), self.view.QDoubleSpinBox_ttl_stop_read_488_2.value(), self.view.QDoubleSpinBox_ttl_stop_camera.value()]
        return sequence_time, axis_lengths, step_sizes, axis_start_pos, analog_start, ttl_starts, ttl_ends
